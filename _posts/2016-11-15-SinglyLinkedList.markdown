...
The documentation for the different methods that come with the SinglyLinkedList is already supplied in the project. Once you have finished implementing the SinglyLinkedList, it would be good to write some tests that make sure your list is working properly. Once you have finished you can proceed to the post about [Queues](https://garbageman.github.io/StructuredLearning/main/2016/11/16/Queue.html)
